...
<form method="GET" action="{{ route('prima-settlements.index', [], false) }}" class="flex flex-col sm:flex-row gap-3 mb-5">
    ...
    <a href="{{ route('prima-settlements.index', [], false) }}" class="h-10 flex items-center px-4 rounded-[var(--radius-control)] bg-[var(--surface-subtle)] border border-[var(--border-default)] text-[var(--text-700)] text-[15px] font-medium hover:bg-[var(--surface-muted)]">
        Limpiar
    </a>
    @endif
</form>
...
<div class="bg-[var(--surface-card)] border border-[var(--border-default)] rounded-[var(--radius-card)] shadow-[var(--shadow-card)] overflow-hidden">
    ...
    <div class="flex flex-col items-center justify-center py-16 text-center">
        ...
        <p class="text-[15px] font-semibold text-[var(--text-700)]">Aún no has generado liquidaciones de prima</p>
        <p class="text-[13px] text-[var(--text-400)] mt-1">Genera la primera para uno de tus clientes con nóminas del semestre ya cargadas</p>
        ...
        <table class="w-full">
            <thead>
                <tr>
                    ...
                    <th class="{{ $thClass }} text-right">Total prima</th>
            ...
            <tbody>
                ...
                <tr class="border-b border-[var(--surface-muted)] border-l-[3px] border-l-transparent hover:border-l-[var(--color-primary)] hover:bg-[var(--surface-subtle)]">
                    <td class="px-6 py-[14px]">
                        <a href="{{ route('prima-settlements.show', $settlement, false) }}" class="text-[14px] text-[var(--text-500)] hover:text-[var(--color-primary)]">
        ...
        <div class="relative bg-[var(--surface-card)] border border-[var(--border-default)] rounded-[var(--radius-card)] shadow-[var(--shadow-card-hover)] w-full max-w-lg overflow-hidden"
            ...
            <div class="flex items-center justify-between px-6 py-5 border-b border-[var(--border-default)]">
                <div class="flex items-center gap-2.5">
                    ...
                    <h2 class="text-[16px] font-bold text-[var(--text-900)]">Generar liquidación de prima</h2>
                    <x-help-icon title="Liquidación de prima">
                        Suma automáticamente la provisión de prima ya calculada mes a mes en las nóminas generadas del cliente dentro del semestre elegido — no vuelve a calcular nada, solo consolida. Genera cada semestre solo una vez.
                    </x-help-icon>
                </div>
