...
<div class="bg-[var(--surface-card)] rounded-[var(--radius-card)] border border-[var(--border-default)] shadow-[var(--shadow-card)] overflow-hidden mb-4">
    ...
    <div class="px-6 pt-5 pb-4">
        ...
        {{-- Fila 1: Tipo · Año base · Estado · Período / N° --}}
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-4">

            <div>
                <label class="{{ $labelClass }}">Tipo</label>
                <input type="text" value="{{ $types[$budget->type] ?? '' }}" disabled
                       class="w-full bg-[var(--surface-muted)] border border-[var(--border-default)] rounded-[var(--radius-control)] px-3.5 h-10 text-[14px] text-[var(--text-400)] cursor-not-allowed"/>
                <p class="text-[11px] text-[var(--text-400)] mt-1">No se puede cambiar</p>
            </div>
            ...
            <div class="flex gap-3">
                <div class="flex-1">
                    ...
                    <select name="period_type" class="{{ $inputClass }}">
                ...
                <div class="w-20">
                    ...
                    <input type="number" name="periods_count" value="{{ old('periods_count', $budget->periods_count) }}"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 pt-4 border-t border-[var(--border-default)]">
            ...
            <div class="lg:col-span-2">
                ...
                <input type="text" name="notes" value="{{ old('notes', $budget->notes) }}" maxlength="500"
