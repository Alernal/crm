...
class PayrollCalculator
{
     ...
     * mientras la Ley 2381 de 2024 siga suspendida por la Corte
     * Constitucional). Solo aplica si el IBC es igual o superior a 4 smmlv,
     * así que en la mayoría de nóminas de PyMEs da 0.
     */
    private function solidarityFundContribution(float $ibc, float $smlv): float
    {
        if ($smlv <= 0) {
            return 0.0;
        }
