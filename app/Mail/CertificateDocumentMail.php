...
class CertificateDocumentMail extends Mailable
{
    ...
    public function content(): Content
    {
        ...
        // reutiliza tal cual ContractDocumentMail/ProposalDocumentMail, sin duplicar
        // plantilla de correo.
    ...
    {
        $pdf = Pdf::loadView('documents.certificates.pdf', ['document' => $this->document])->setPaper('letter');
